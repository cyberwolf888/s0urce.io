...
config = {
	...
	message: "KILLeD by KILLeR.©",
	autoTarget: true,
	autoAttack: true,
	// the base64 database url
	db: "https://raw.githubusercontent.com/SadHand/s0urce.io/master/db.json",
	...
	show: () => {
		...
		<div id="custom-gui" class="window" style="border-color: rgb(62, 76, 95); color: rgb(191, 207, 210); ${sizeCSS} z-index: 10; top: 11.5%; left: 83%;">
			...
			<div class="window-content" style="${sizeCSS}">
				...
				${freqInput("upgrade")}
				${freqInput("hack")}
				<div id="custom-vk-button" class="button" style="display: block;">
					The bot creator: SadHand ©
				</div>
			</div>
		</div>`;
		...
		$("#custom-vk-button").on("click", () => {
			window.open("https://vk.com/a.gordasch");
		});
